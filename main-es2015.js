...
const routes = [
    {
        path: 'customers',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_customers_customers_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./customers/customers.module */ 7258)).then(m => m.CustomersModule)
    },
    {
        path: 'orders',
...
AppRoutingModule.ɵinj = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({ providers: [], imports: [[
...
AppComponent.ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], decls: 9, vars: 1, consts: [["routerLink", "/customers"], ["routerLink", "/orders"], ["routerLink", ""]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
